...
<body>
  <header>
    ...
    <time id="currentTime"
      data-initial-time="<?php echo $defaultDate->format('Y-m-d H:i:s'); ?>">
      <!-- ちらつき防止 -->
      <?php echo $defaultDate->format('Y-m-d H:i:s'); ?>
    </time>
    <p>元旦を熱い気持ちで迎えましょう！</p>
  ...
  <script src="js/updateClock.js" type="module"></script>
  <script src="js/getTimezone.js" type="module"></script>
